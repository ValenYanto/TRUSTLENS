...
export default function AuditLogsPage() {
  ...
  async function loadLogs() {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Gagal memuat log audit");
    } finally {
      setLoading(false);
    }
  }
  ...
  const uniqueAktor = new Set(logs.map((log) => log.actor)).size;
      ...
      <section className="flex flex-col justify-between gap-6 xl:flex-row xl:items-end">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-base leading-7 text-slate-400">
            Pantau aktivitas autentikasi, simulasi fraud, investigasi peringatan, pelabelan transaksi, dan proses backend.
          </p>
        </div>
      ...
      <section className="grid gap-4 xl:grid-cols-[1fr_1.2fr]">
        ...
        <div className="trust-panel-sdarit rounded-md p-4">
          <div className="mb-3 flex items-center justify-between">
            <p className="trust-label">Filter aksi</p>
        ...
        <div className="space-y-6">
          <Card className="trust-panel rounded-md border-cyan-300/10 text-slate-100">
            <CardContent className="p-6">
              <p className="trust-label">Event terbaru</p>

              {!latestLog ? (
                <p className="mt-5 text-sm text-slate-500">Belum ada event.</p>
              ) : (
          ...
          <Card className="trust-panel rounded-md border-cyan-300/10 text-slate-100">
            <CardContent className="p-6">
              <div className="flex items-start justify-between">
                <div>
                  <p className="trust-label">Integritas log</p>
              ...
              <div className="mt-6 space-y-3">
                <ProtocolRow label="Penyimpanan" value="PostgreSQL" />
                <ProtocolRow label="Mode" value="Append-only demo" />
                <ProtocolRow label="Status" value="Aktif" active />
                <ProtocolRow label="Cakupan" value="Auth / Peringatan / Label" />
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="trust-panel rounded-md border-cyan-300/10 text-slate-100">
            <CardContent className="p-6">
              <p className="trust-label">Distribusi aksi</p>
